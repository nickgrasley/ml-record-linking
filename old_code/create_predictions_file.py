...
def create_prediction_file(predictions_df, out_file, chunk_index, has_arks=True, ark_pairs_file=None, years=["1910", "1920"]):
    ...
    """
    pred_file = f"R:/JoePriceResearch/record_linking/projects/deep_learning/ml-record-linking/data/predictions1900_1920/chunk_{chunk_index}.csv"
