...
def main(file_name, hyper_params):
    ...
    feature_interactions = [[]] #FIXME set feature interactions.
    clf = XGBClassifier(interaction_constraints=feature_interactions, n_jobs=4, random_state=94)
...
if __name__ == "__main__":
    ...
    model, X_train, X_test, Y_train, Y_test, pairs_df = main("R:/JoePriceResearch/RA_work_folders/Nicholas_Grasley/random_training.dta")
    end = time()
